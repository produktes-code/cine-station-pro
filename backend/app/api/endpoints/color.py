...
async def auto_white_balance(request: Request, video_path: str, output_path: str):
    ...
    try:
        ...
        return {"status": "success", "message": "Automatic white balance applied successfully."}
...
async def auto_exposure(request: Request, video_path: str, output_path: str):
    ...
    try:
        ...
        return {"status": "success", "message": "Automatic exposure correction applied successfully."}
    except Exception as e:
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def adjust_color(
    ...
    try:
        ...
        return {"status": "success", "message": "Lift, Gamma, and Gain color wheels adjusted successfully."}
    except Exception as e:
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
@router.post("/preset")
@limiter.limit("10/minute")
async def apply_preset(request: Request, video_path: str, preset_name: str, output_path: str):
    """
    ...
    try:
        ...
        return {"status": "success", "message": f"Color grading preset '{preset_name}' applied successfully."}
    except Exception as e:
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
